...
def parse_args():
    ...
    parser.add_argument('--script', type=str, default='ourtrack', choices=['ourtrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='STFTrack-ep150-full-384-nofm', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    args = parse_args()
    '''update cfg'''
    yaml_fname = '/home/zch2023022459/project/AQATrack-main/experiments/%s/%s.yaml' % (args.script, args.config)
