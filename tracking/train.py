...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='stftrack', help='training script name')
...
def main():
    args = parse_args()
    if args.mode == "single":
        train_cmd = "/root/anaconda3/envs/stftrack/bin/python3.8 lib/train/run_training.py --script %s --config %s --save_dir %s --use_lmdb %d " \
