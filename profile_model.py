...
def parse_args():
    ...
    parser.add_argument('--script', type=str, default='stftrack', choices=['stftrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='STFTrack-ep150-full-384', help='yaml configure file name')
