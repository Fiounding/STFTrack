...
from lib.models.ourtrack import build_ourtrack
...
class OurTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(OurTrack, self).__init__(params)
        network = build_ourtrack(params.cfg, training=False)
