...
"""
Add default config for OURTrack.
"""
cfg = edict()
...
cfg.MODEL.CSAM = edict()
cfg.MODEL.CSAM.SEMANTIC = True
cfg.MODEL.CSAM.POSITIONAL = True
cfg.MODEL.CSAM.SLICE = False
cfg.MODEL.CSAM.UNCERTAINTY = False
cfg.MODEL.CSAM.RANK = 5
cfg.MODEL.USE_CSAM = True
# MODEL.BACKBONE
